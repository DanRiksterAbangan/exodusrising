...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    <!--begin::Title-->
    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">My Account</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
...
<div class="row gx-5 gx-xl-10">
    ...
    <div class="col-xxl-4 mb-5 mb-xl-10">
        ...
        <div class="card card-flush h-xl-100" style="background-color: #202B46; background-image:url('assets/media/svg/shapes/widget-bg-2.png')" data-theme="light">
            <!--begin::Body-->
