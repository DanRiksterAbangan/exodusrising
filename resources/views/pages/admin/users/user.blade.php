                    ...
                    <div class="col-12 col-xxl-6">
                        <div class="row">
                            @forelse  ($characters as $character)
                                <div
                                    class="col-md-12 col-lg-6 col-xl-6 col-xxl-{{ $characters->count() > 1 ? '6' : '12' }} mb-md-5 tw-mb-6">
                            ...
                            <div class="card-body pt-4 tw-relative">
                                ...
                                <div class="tw-flex tw-items-center">
                                    <span class="tw-text-lg tw-font-semibold tw-text-gray-500">
                                        {{ $userData->login_id }} <span
                                            class="badge badge-primary">{{ $userData->user_id }}</span></span>
                                </div>


                                <div class="tw-absolute tw-top-4 tw-right-4 tw-text-gray-500 tw-text-sm tw-italic">
                                    Last login: {{ (new Carbon($userData->session_date))->diffForHumans() }}
                                </div>
                            </div>
                        </div>
                    </div>
