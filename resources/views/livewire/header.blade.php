        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
            <div class="app-header-menu app-header-mobile-drawer align-items-stretch">
                <div
                    ...
                    <div class="app-header-menu app-header-mobile-drawer align-items-stretch" wire:ignore>
                        <div
                            class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0">
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-lg-3">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                        data-kt-menu="true" data-kt-element="theme-mode-menu" wire:ignore>
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" data-kt-value="light"
                                wire:ignore>
                                <span class="menu-icon" data-kt-element="icon" wire:ignore>
                        ...
                        <div class="menu-item px-3 my-0">
                            <a href="#" class="menu-link px-3 py-2" data-kt-element="mode" wire:ignore
                                data-kt-value="dark">
