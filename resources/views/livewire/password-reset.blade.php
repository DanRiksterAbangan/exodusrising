<div>
    <form class="form w-100" novalidate="novalidate" wire:submit.prevent="submit">
        ...
        <div class="fv-row mb-4">
            <input type="text" placeholder="Email" value="{{$email}}" readonly name="email" autocomplete="off"
        ...
        <div class="fv-row mb-4">
            <input type="password" placeholder="Confirm Password" wire:model="password_confirmation" name="password_confirmation" autocomplete="off"
                class="form-control bg-transparent" />
