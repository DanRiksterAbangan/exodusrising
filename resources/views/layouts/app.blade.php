...
<head>
    ...
    <title>Exodus Rising</title>

    <link nonce="{{ csp_nonce() }}" rel="icon" type="image/png" href="{{ asset('/assets/images/logo.ico') }}">
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                        ...
                        <div id="kt_app_footer" class="app-footer">
                            <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
                                <div class="text-dark order-2 order-md-1">
                                    ...
                                    <a href="/" target="_blank" class="text-gray-800 text-hover-primary">Exodus Rising</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script nonce="{{ csp_nonce() }}" src="{{ asset('assets/js/scripts.bundle.js') }}"></script>
    @stack('scripts')
