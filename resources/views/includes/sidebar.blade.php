...
<!--begin:Menu item-->
<div class="menu-item @if(Request::route()->getName() == 'home') here show @endif menu-accordion">
<!--begin:Menu link-->
...
<div class="menu-item @if(Request::route()->getName() == 'myaccount') here show @endif menu-accordion">
    <!--begin:Menu link-->
        <a class="menu-link" href="{{ route("myaccount") }}">
            <span class="menu-icon">
                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                <span class="svg-icon svg-icon-2">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<a class="menu-link" href="https://preview.keenthemes.com/html/keen/docs/getting-started/changelog" target="_blank">
    ...
    <span class="menu-title">Changelog v3.0.2</span>
</a>
<!--end:Menu link-->
</div>
<!--end:Menu item-->
